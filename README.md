...
1. To run this project, you will need to download the following GGUF model from Hugging Face:
mistral-7b-instruct-q4-k-m-gguf
Example model path used in the project:
mistral-7b-instruct-q4-k-m-gguf/gguf/default/1
2. Place the downloaded model inside the appropriate project directory before running the code.
